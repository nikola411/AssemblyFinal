...
void Conversion::InstructionEntry(eAssemblyIdentifier instruction, std::vector<AddressingEntry> entries)
{
    for (const auto& addr : entries)
        for (const auto& payload : addr.payloadEntry)
                methods[{instruction, addr.type, payload.type}] = payload.processorInstructions;
}
...
{
    methods[{instruction, eAddressingType::ADDR_NONE, ePayloadType::PAYLOAD_NONE}] = processorInstructions;
}
...
{
    methods[{instruction, eAddressingType::ADDR_DIRECT, ePayloadType::PAYLOAD_GPR}] = processorInstructions;
}
...
{
    methods[{instruction, type, ePayloadType::PAYLOAD_VALUE}] = processorInstructions;
}
...
{
    methods[{instruction, eAddressingType::ADDR_DIRECT, ePayloadType::PAYLOAD_CSR}] = processorInstructions;
}
...
{
    { eValueToUse::FIRST_OPERAND, 0 },
    { eValueToUse::SECOND_OPERAND, 1 },
    { eValueToUse::THIRD_OPERAND, 2 },
    { eValueToUse::FIRST_OFFSET, -3}, // will be adding 3 to this val ue
    { eValueToUse::SECOND_OFFSET, -2 },
    { eValueToUse::THIRD_OFFSET, -1 },
    { eValueToUse::NONE, INT32_MAX },
    { eValueToUse::POOL_ENTRY, INT32_MAX }
};
